...
agents:
  ...
  documentation_helper:
    ...
    system_prompt: |
      ...
      2. Load reference files: "skill://local/documentation-style-guide/references/headings.md"
      3. Load examples: "skill://local/documentation-style-guide/references/examples/api-doc.md"
  ...
  reference_explorer:
    ...
    system_prompt: |
      ...
      - skill://local/documentation-style-guide/references/structure.md
      - skill://local/documentation-style-guide/references/formatting.md
      - skill://local/documentation-style-guide/references/examples/
